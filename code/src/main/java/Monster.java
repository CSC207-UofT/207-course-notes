 ...
 * A monster.
 *
 * <p>A very silly program to demonstrate the basics of defining your own classes.
 */
public class Monster {
  ...
  */
  ...
  /**
   * Puts Monster m in this Monster's belly, as long as this Monster's belly has room and m's belly
   * is empty.
   *
  ...
  */
  ...
  /**
   * Returns a string representation of the object, including this Monster's name, size, and the
   * contents of its belly.
   *
  ...
  */
  ...
  /**
   * Returns true iff this Monster is equivalent to obj, meaning that they have the same name and
   * size, and equivalent belly contents.
   *
  ...
  */
  ...
  /**
   * Creates several monsters, has them eat one another, and prints the results.
   *
  ...
  public static void main(String[] args) {
    ...
    Monster m4 = new Monster();
    final Monster[] scarey = {m0, m1, m2, m3, m4};
