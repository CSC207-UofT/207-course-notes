...
public abstract class Author {
  ...
  /**
   * Sorts this author's books. There are different algorithms for sorting books of an author (e.g.,
   * Insertion Sort and Selection Sort). Therefore, leaving the implementation of the sorting
   * algorithm open for different authors.
   */
  public abstract void sortBooks();

  /**
   * Displays the books of this author. The books of an author can be displayed in different ways
   * (e.g., ascending order and descending order). Therefore, leaving the implementation open for
   * different authors.
   */
