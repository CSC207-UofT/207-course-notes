...
## 2.4. Constructors
Equivalent to the `__init__` method in Python, we have constructors in . These are methods with no return type (not even void), which get called whenever a new instance of a class is created.
